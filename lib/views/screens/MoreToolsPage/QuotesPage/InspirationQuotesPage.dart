...
class InspirationQuotesPage extends StatefulWidget {
  const InspirationQuotesPage({super.key});

  @override
  State<InspirationQuotesPage> createState() => _InspirationQuotesPageState();
}

class _InspirationQuotesPageState extends State<InspirationQuotesPage> {
  @override
  void initState() {
    super.initState();
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    Column(
                      children: InspirationQuotes.map(
                        (e) => Column(
                          children: [
                            Container(

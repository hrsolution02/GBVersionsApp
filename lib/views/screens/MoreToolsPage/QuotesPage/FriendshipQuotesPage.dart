...
class FriendshipQuotesPage extends StatefulWidget {
  const FriendshipQuotesPage({super.key});

  @override
  State<FriendshipQuotesPage> createState() => _FriendshipQuotesPageState();
}

class _FriendshipQuotesPageState extends State<FriendshipQuotesPage> {
  @override
  void initState() {
    super.initState();

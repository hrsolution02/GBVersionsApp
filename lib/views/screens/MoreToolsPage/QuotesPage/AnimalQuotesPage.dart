...
class AnimalQuotesPage extends StatefulWidget {
  const AnimalQuotesPage({super.key});

  @override
  State<AnimalQuotesPage> createState() => _AnimalQuotesPageState();
}

class _AnimalQuotesPageState extends State<AnimalQuotesPage> {
  @override
  void initState() {
    super.initState();

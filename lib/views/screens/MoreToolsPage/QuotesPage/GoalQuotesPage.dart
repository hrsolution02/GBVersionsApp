...
class GoalQuotesPage extends StatefulWidget {
  const GoalQuotesPage({super.key});

  @override
  State<GoalQuotesPage> createState() => _GoalQuotesPageState();
}

class _GoalQuotesPageState extends State<GoalQuotesPage> {
  @override
  void initState() {
    super.initState();

...
class AttitudeQuotesPage extends StatefulWidget {
  const AttitudeQuotesPage({super.key});

  @override
  State<AttitudeQuotesPage> createState() => _AttitudeQuotesPageState();
}

class _AttitudeQuotesPageState extends State<AttitudeQuotesPage> {
  @override
  void initState() {
    super.initState();

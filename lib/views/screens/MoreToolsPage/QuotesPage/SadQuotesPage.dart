...
class SadQuotesPage extends StatefulWidget {
  const SadQuotesPage({super.key});

  @override
  State<SadQuotesPage> createState() => _SadQuotesPageState();
}

class _SadQuotesPageState extends State<SadQuotesPage> {
  @override
  void initState() {
    super.initState();

...
class LoveQuotesPage extends StatefulWidget {
  const LoveQuotesPage({super.key});

  @override
  State<LoveQuotesPage> createState() => _LoveQuotesPageState();
}

class _LoveQuotesPageState extends State<LoveQuotesPage> {
  @override
  void initState() {
    super.initState();

...
class BrokenHeartQuotesPage extends StatefulWidget {
  const BrokenHeartQuotesPage({super.key});

  @override
  State<BrokenHeartQuotesPage> createState() => _BrokenHeartQuotesPageState();
}

class _BrokenHeartQuotesPageState extends State<BrokenHeartQuotesPage> {
  @override
  void initState() {
    super.initState();
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    Column(
                      children: BrokenHeartQuotes.map(
                        (e) => Column(
                          children: [
                            Container(

...
class CrushQuotesPage extends StatefulWidget {
  const CrushQuotesPage({super.key});

  @override
  State<CrushQuotesPage> createState() => _CrushQuotesPageState();
}

class _CrushQuotesPageState extends State<CrushQuotesPage> {
  @override
  void initState() {
    super.initState();

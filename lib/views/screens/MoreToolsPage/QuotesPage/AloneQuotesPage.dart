...
class AloneQuotesPage extends StatefulWidget {
  const AloneQuotesPage({super.key});

  @override
  State<AloneQuotesPage> createState() => _AloneQuotesPageState();
}

class _AloneQuotesPageState extends State<AloneQuotesPage> {
  @override
  void initState() {
    super.initState();
